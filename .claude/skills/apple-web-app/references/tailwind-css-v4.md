...
```html
<div
  class="absolute inset-x-0 top-0 w-[var(--page-width,100%)] h-[var(--page-height,100%)] isolate"
>
  <div
    class="sticky top-[calc(var(--visual-viewport-height,100vh)/2)] -translate-y-1/2 max-h-[calc(var(--visual-viewport-height,100vh)-2rem)]"
  >
    <!-- Dialog content -->
  </div>
</div>
